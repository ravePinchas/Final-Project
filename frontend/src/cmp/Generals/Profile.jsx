  ...
  return (
    <section className="profile-bar">
      <div className="text-profile-div">
        <span>{currentUser ?('hello ' + currentUser.username ): 'hello' }</span>
        <button>
        ...
        <div onClick={onAddPopupProfile} className="user-btn-profile">
          ...
          <div className={isPopup ? "popup-profile" : "not-popup-profile"}>
            ...
            <div>Gift card</div>
            <Link to="/hosting"> <span className='hosting-link'>Hosting</span></Link>
          </div>
        </div>
      </div>
      ...
      <div className={isPopupLog || isPopupSign ? "popup-log" : "not-popup-log"}>
        ...
        <hr />
        {isPopupSign && <SignUp onAddPopupSign={onAddPopupSign}/>}
        {isPopupLog && <LoginProfile onAddPopupLog={onAddPopupLog}/>}
      </div>
    </section>
  )
}
